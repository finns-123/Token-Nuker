...
colorama.init()
token = input(f"Introduce un token {Fore.RED}[$] >> ")

servername= input(f"{Fore.RESET}Introduce nombre de servidores a spamear {Fore.RED}[$] >> ")
...
def Home():
  ...
  {Fore.WHITE}           ╚══════════════════════════════════╝
  {Fore.RED}             
  {Fore.RED}         Si algun comando no funca, notificar a mi DM
  ''')                           
  shit = input("[$] >> ")
  if shit == '1':
    serverspam()
